...
- Artem's Entrepreneurship-Bank ([link](https://github.com/Entrepreneurship-Bank)): <sub>My personal incubator for new ideas and early-stage projects — experimenting and prototyping before ideas evolve further.</sub>  
...
- MedVision+ ([link](https://github.com/NUS-MedVision)): <sub>Full-stack diagnostic assistant developed for my NUS final year project — supports multi-modal medical scans with deep learning models & LLMs.</sub>
